...
exports.fibIter = curry((n) => {
     ...
     * @returns A Fibonacci number of a specific index using Iterative process
     */
    const fibIterHelper = (acc1, acc2, num) => {
        return (num === 2) ? acc1 : fibIterHelper((acc1 + acc2), acc1, NumericalComputation_1.sub1(num));
    };
    return fibIterHelper(1, 1, n);
});
//# sourceMappingURL=FibonacciIter.js.map